    ...
    /*override func dismissTransition(containerView: UIView, fromViewController: UIViewController, toViewController: UIViewController) {
        ...
        UIView.animateWithDuration(0.5, animations: { () -> Void in
            fromViewController.view.alpha = 0
                ...
                UIView.animateWithDuration(0.9, delay: 0, usingSpringWithDamping: 0.65, initialSpringVelocity: 0.5, options: UIViewAnimationOptions.CurveEaseInOut, animations: { () -> Void in
                        cardHome.selectedCard.transform = CGAffineTransformMakeScale(0.8, 0.8)
                        cardHome.selectedCard.frame.origin.y = 150
                    }, completion: { (Bool) -> Void in
    ...
    override func dismissTransition(containerView: UIView, fromViewController: UIViewController, toViewController: UIViewController) {
        ...
        UIView.animateWithDuration(0.5, animations: { () -> Void in
            fromViewController.view.alpha = 0
                ...
                UIView.animateWithDuration(1.2, delay: 0, usingSpringWithDamping: 0.65, initialSpringVelocity: 0.5, options: UIViewAnimationOptions.CurveEaseInOut, animations: { () -> Void in
                    cardHome.selectedCard.transform = CGAffineTransformMakeScale(0.8, 0.8)
                    cardHome.selectedCard.frame.origin.y = 150
                    cardHome.selectedCard.alpha = 0
                    }) { (Bool) -> Void in
