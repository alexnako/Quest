...
var orangeCard: UIColor! = UIColor(red: 220/255, green: 160/255, blue: 60/255, alpha: 1)
var salmonCard: UIColor! = UIColor(red: 230/255, green: 75/255, blue: 80/255, alpha: 1)
var lilacCard: UIColor! = UIColor(red: 170/255, green: 110/255, blue: 180/255, alpha: 1)
var defaultCardColour: UIColor! = UIColor(red: 0.5, green: 0.5, blue: 0.5, alpha: 1)

var colorIndex:[Int]! = [0,1,2,3,4]
var colorSet:[UIColor]! = [blueCard,greenCard,orangeCard,salmonCard,lilacCard]
...
class ComposerTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        colorSelected = colorIndex.randomItem()
        cardColor = colorSet[colorSelected]
...
//        NSNotificationCenter.defaultCenter().addObserver(self, selector: "refreshPlan:", name:"refresh", object: nil)
...
//    func refreshPlan(notification: NSNotification) {
//        print("refresh\(photosSelected)")
//        if (photosSelected != nil) {
//            print(photosSelected)
//            let photos = photosSelection + photosSelected
...
//    
    ...
    @IBAction func didPressCreate(sender: AnyObject) {
        ...
        plan["color"] = String(colorSelected)
